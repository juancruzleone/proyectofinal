        ...
        <Layout>
            ...
            <div className={styles.contenedorCardServicios}>
                <div className={styles.cardServicios}>
                    <Image src="/instalaciones.webp" alt="icono instalaciones" className={styles.iconoServiciosCard} width={140} height={140}/>
                ...
                <div className={styles.cardServicios}>
                    <Image src="/mantenimiento.webp" alt="icono mantenimiento" className={styles.iconoServiciosCard} width={140} height={140}/>
                ...
                <div className={styles.cardServicios}>
                    <Image src="/servicio-tecnico.webp" alt="icono servicio tecnico" className={styles.iconoServiciosCard} width={140} height={140}/>
                ...
                <div className={styles.cardServicios}>
                    <Image src="/provisiones.webp" alt="icono provisiones" className={styles.iconoServiciosCard} width={140} height={140}/>
